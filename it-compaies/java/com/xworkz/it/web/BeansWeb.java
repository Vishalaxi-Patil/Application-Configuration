...
public class BeansWeb extends HttpServlet {
	public BeansWeb() {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String quantityFrmGet=req.getParameter("quantity");
		...
		writer.println("</br>");
		writer.println("<b>");
		writer.println("Beans "+quantityFrmGet+ " "+priceFrmGet+" data is success");
		writer.println("</b>");
		writer.println("</body>");
		writer.println("</html>");
		writer.flush();
